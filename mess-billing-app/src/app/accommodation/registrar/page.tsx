...
export default function RegistrarDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative py-12 px-4 sm:px-6 lg:px-8">
      {/* Background Decor */}
      <div className="absolute top-0 left-0 w-full h-80 bg-violet-600 rounded-b-[4rem] z-0 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-violet-500 rounded-full blur-3xl opacity-50"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10 text-white">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight">Assistant Registrar Portal</h1>
            <p className="mt-2 text-violet-100 font-medium text-lg">Verify administrative requests prior to Warden issuance</p>
          </div>
                      ...
                      {requests.map(req => (
                         <tr key={req.id} className="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td className="p-4">
                               ...
                               <div className="text-xs font-bold text-violet-600">Category {req.category}</div>
                            </td>
                            <td className="p-4">
