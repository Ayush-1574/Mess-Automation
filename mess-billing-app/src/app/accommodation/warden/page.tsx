...
export default function WardenDashboard() {
  ...
  const approvedRequests = processedRequests.filter(req => req.wardenStatus === 'APPROVED');
  const rejectedRequests = processedRequests.filter(req => req.wardenStatus === 'REJECTED');
