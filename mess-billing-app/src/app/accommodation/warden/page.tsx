...
export default function WardenDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative py-12 px-4 sm:px-6 lg:px-8">
      {/* Background Decor */}
      <div className="absolute top-0 left-0 w-full h-80 bg-orange-600 rounded-b-[4rem] z-0 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-orange-500 rounded-full blur-3xl opacity-50"></div>
        <div className="absolute top-32 -left-24 w-72 h-72 bg-amber-500 rounded-full blur-3xl opacity-50"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10 text-white">
          <div>
            <h1 className="text-4xl font-extrabold tracking-tight">Chief Warden Portal</h1>
            <p className="mt-2 text-orange-100 font-medium text-lg">Final approval and room allocation for accommodation requests</p>
          </div>
                ...
                <table className="w-full text-left border-collapse">
                   <thead className="sticky top-0 z-20 bg-slate-50/95 backdrop-blur-sm shadow-sm">
                      <tr className="border-b border-slate-200 uppercase text-xs font-extrabold text-slate-500 tracking-wider">
                         ...
                         <th className="p-4">Duration & Timings</th>
                      ...
                      {requests.map(req => (
                         <tr key={req.id} className="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td className="p-4">
                               ...
                               <div className="text-xs font-bold text-orange-600">Category {req.category}</div>
                            </td>
                            <td className="p-4">
            ...
            <div className="p-6 overflow-y-auto space-y-6">
              ...
              {viewRequest.financialSupportAmount && (
                <div className="border-t border-slate-100 pt-6">
                  ...
                  <p className="text-orange-600 font-bold text-xl">₹{viewRequest.financialSupportAmount}</p>
                </div>
              )}
            </div>
          </div>
